...
@NamedQuery(name="CactusSchoolMaster.findAll", query="SELECT s FROM CactusSchoolMaster s")
@Where(clause="delete_ind is NULL or delete_ind='N'")
public class CactusSchoolMaster implements Serializable {
